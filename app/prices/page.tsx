...
const PricesPage = () => {
  return <Container className="mt-5 flex flex-col gap-5">
    <section>
    ...
    <section>
      ...
      <div className="hover:shadow-light p-5 rounded">
    ...
    <section>
      ...
      <div className="box-border shadow-light text-[17px] mx-0 my-5 p-5 rounded-md background: #e7eaf3;">
